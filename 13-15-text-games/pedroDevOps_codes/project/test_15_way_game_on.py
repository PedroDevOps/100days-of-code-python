...
from game_on import player_chooses_roll, print_header, build_the_three_rolls, get_players_name, get_random_roll, game_loop
...
def test_player_chooses_roll(inp, rolls_list = three_rolls, rock_roll = roll_of_a_rock, paper_roll = roll_of_a_paper, scissor_roll = roll_of_a_scissor):
