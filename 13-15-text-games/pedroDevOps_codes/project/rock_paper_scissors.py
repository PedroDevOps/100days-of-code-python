...
class Roll:
    ...
    def __init__(self, roll_name, wins_aggainst_rolls_name_list, losses_aggainst_rolls_name_list):
    ...
    def __eq__(self, other): 
        if isinstance(self,other.__class__):
            return (self.roll_name == other.roll_name and 
                self.wins_aggainst_rolls_name_list == other.wins_aggainst_rolls_name_list and 
                self.losses_aggainst_rolls_name_list == other.losses_aggainst_rolls_name_list)
        return False
