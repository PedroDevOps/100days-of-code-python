...
def main():
    print("Today is {}, a wonderful day to begin my 100days of code with Python".format(date(2021, 12, 26,)))
    ...
    if myBirthday < myWifeBirthday:
        print("I am " + str(compareDates(myWifeBirthday, myBirthday).days) + " days older than your wife!")
        print("I am " + str((compareDates(myWifeBirthday, myBirthday).days)*24*60*60 ) + " seconds older than your wife!")
    else:
        print("I am " + str(compareDates(myWifeBirthday, myBirthday).days) + " days younger than your wife!")
        print("I am " + str((compareDates(myWifeBirthday, myBirthday).days)*24*60*60 ) + " seconds younger than your wife!")
